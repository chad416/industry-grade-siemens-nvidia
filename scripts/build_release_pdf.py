...
story = [
    ...
    table([["Gate", "Evidence", "Status"],
           ...
           ["Deterministic regression", "99 Siemens/simulator/source/native-contract + 85 edge-service + 17 interface-harness tests; 32 process and 28 structured behavioral fault-injection cases", "SOURCE/LOCAL PASS - not PLCSIM/HIL"],
           ...
           ["NVIDIA software", "85/85 edge tests including 9 certificate-backed local asyncua cases; 47-node map, terminal-before-valid ordering, durable-audit failure interlock and 28-case behavioral injection pass", "PARTIAL - production endpoint/native binding open"],
