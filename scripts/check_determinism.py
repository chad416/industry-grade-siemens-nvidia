...
report = [
    ...
    "",
    f"Two independent temporary exports of authoritative Git {OPTIONS.source} bytes ran canonical generation, all 32 scenarios and read-only deterministic validation.",
